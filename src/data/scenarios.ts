    ...
    steps: [
      {
        ...
        choices: [
          {
            id: 'c1-a',
            text: 'A line chart showing retention over the first 5 days for users who completed onboarding versus those who skipped it.',
            isCorrect: true,
            feedback: 'Great choice! The line chart makes the Day 3 drop-off easy to spot while preserving the trend difference between the two onboarding groups.',
            scoreImpact: 20,
          },
          {
            id: 'c1-b',
